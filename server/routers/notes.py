...
async def get_notes(tg_id: int, tag: str = None, service: NoteService = Depends(), ):
...
async def post_note(data: NoteCreation, service: NoteService = Depends()) -> dict[str, str]:
...
async def delete_note(note_id: int, service: NoteService = Depends()) -> dict[str, str]:
...
async def patch_note(note_id: int, data: NoteUpdate, service: NoteService = Depends()) -> dict[str, str]:
